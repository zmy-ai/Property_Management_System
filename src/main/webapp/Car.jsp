        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed" >
                    <a class="" href="/user.do"><span class="myfont"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;首页</span></a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
        ...
        <div style="padding: 0px;">
            ...
            <div class="big"  >
                <script type="text/javascript">
                    ...
                    function delCars() {
                        document.Fname.action = "${pageContext.request.contextPath }/delCars.do";
                        document.Fname.submit();
                    }
                </script>
                <div class="layui-btn-group demoTable">
                    <button class="layui-btn" data-type="isAll" onclick="addCar()">添加</button>
                    <button class="layui-btn" data-type="getCheckLength" onclick="delCars()">批量删除</button>
                </div>
                <form action="" method="get" name="Fname">
                <table class="layui-table" lay-data="{width: 1398, height:800, page:true}">
                    <thead>
                    <tr>
                        ...
                        <th lay-data="{field:'home', width:160,sort: true}">所属业主</th>
                        ...
                        <c:forEach items="${list}" var="car">
                            <tr>
                                ...
                                <td>${car.type}</td>
                                <td>${car.car_area}</td>
                                <td>${car.user_account.username}</td>
                                <td>${car.createtime}</td>
                                <td>${car.outTime}</td>
                                <td><a href="/upCar.do?id=${car.id}">编辑</a>
                                    <a href="/delCar.do?id=${car.id}">删除</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                </table>
