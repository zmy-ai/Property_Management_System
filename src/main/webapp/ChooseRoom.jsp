...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 0px;">
            <div class="page-top">
                <span style="color: #777777;font-size: 18px;font-family: 华文新魏;margin: 0 auto;"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;首页&nbsp;&gt;房号绑定&gt;房间信息</span>
            </div>
            <div class="big"  >
                <script type="text/javascript">
                    function bind_information(){
                        document.Fname.action = "${pageContext.request.contextPath }/bind_information.do";
                        document.Fname.submit();
                    }
                </script>
                <form action="/selectByFloorName.do" method="get" class="Form">
                    <input type="text" value="${user_account.username}" name="username" readonly="readonly">
                </form>
                <div class="layui-btn-group demoTable">
                    <button class="layui-btn" data-type="isAll" onclick="bind_information()">添加</button>
                </div>
                <form action="" method="get" name="Fname">
                <table class="layui-table" lay-data="{width: 824, height:800, page:true}">
                    <thead>
                    <tr>
                        ...
                        <tbody>
                        <input type="text" value="${user_account.id}" id="user_id" name="user_id" hidden>
