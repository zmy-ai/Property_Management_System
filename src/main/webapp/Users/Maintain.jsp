    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="/User_maintain.do?id=${user_account.id}"  style="background-color: #009688"><span class="myfont"><i class="fa fa-circle-o" aria-hidden="true"></i>&nbsp;报修管理</span></a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="/User_Complain.do?id=${user_account.id}" ><span class="myfont"><i class="fa fa-circle-o" aria-hidden="true"></i>&nbsp;投诉信息</span></a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="big"  >
                <script type="text/javascript">
                    function addMaintain(){
                        document.Fname.action = "${pageContext.request.contextPath }Users/AddMaintain.jsp";
                        document.Fname.submit();
                    }
                    function deleteMaintains(){
                        document.Fname.action = "${pageContext.request.contextPath }/deleteMaintains.do";
                        document.Fname.submit();
                    }
                </script>
                <div class="layui-btn-group demoTable">
                    <button class="layui-btn" data-type="isAll" onclick="addMaintain()">添加</button>
                    <button class="layui-btn" data-type="getCheckLength" onclick="deleteMaintains()">批量删除</button>
                </div>
                    ...
                    <tr>
                        ...
                        <c:forEach items="${list}" var="maintain">
                            <tr>
                                ...
                                <td><a href="/upMaintain.do?id=${maintain.id}&userId=${user_account.id}">确认</a>
                                    <a href="/delMaintain.do?id=${maintain.id}&userId=${user_account.id}">删除</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                </table>
