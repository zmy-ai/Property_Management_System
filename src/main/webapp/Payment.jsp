    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="/showPay.do" style="background-color: #009688" ><span class="myfont"><i class="fa fa-circle-o" aria-hidden="true"></i>&nbsp;缴费信息</span></a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="/showMaintain.do"><span class="myfont"><i class="fa fa-circle-o" aria-hidden="true"></i>&nbsp;报修管理</span></a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="/showComplaint.do" ><span class="myfont"><i class="fa fa-circle-o" aria-hidden="true"></i>&nbsp;投诉信息</span></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div style="padding: 0px;">
            ...
            <div class="big"  >
                <script type="text/javascript">
                    function addPayment(){
                        document.Fname.action = "${pageContext.request.contextPath }/addPayment.do";
                        document.Fname.submit();
                    }
                    function queryPayments(){
                        document.Fname.action = "${pageContext.request.contextPath }/queryPayments.do";
                        document.Fname.submit();
                    }
                    function delPayments() {
                        document.Fname.action = "${pageContext.request.contextPath }/delPayments.do";
                        document.Fname.submit();
                    }
                ...
                <div class="layui-btn-group demoTable">
                    ...
                    <button class="layui-btn" data-type="getCheckData" onclick="queryPayments()">批量查看</button>
                    <button class="layui-btn" data-type="getCheckLength" onclick="delPayments()">批量删除</button>
                </div>
                        ...
                        <c:forEach items="${list}" var="payment">
                            <tr>
                                ...
                                <td><a href="/upPayment.do?id=${payment.id}">编辑</a>
                                    <a href="/delPayment.do?id=${payment.id}">删除</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                </table>
