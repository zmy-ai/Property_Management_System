    ...
    <div class="layui-body">
        ...
        <div style="padding: 0px;">
            ...
            <div class="big">
                <div class="action">
                    <center>
                        <form name="user" action="addRoom.do" method="post" onsubmit=" return validate()">
                            <table width=70% border=1>
                                ...
                                <tr>
                                    <th>单元</th>
                                    <td><input type="text" id="floor_unit" name="floor_unit"></td>
                                </tr>
                                <tr>
                                    <th>房间号</th>
                                ...
                                <tr>
                                    <th>房间面积</th>
                                    <td><input type="text" id="room_area" name="room_area" ></td>
                                </tr>
                                <tr>
