...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="/Complaintshow.do"style="background-color: #009688"><span class="myfont"><i class="fa fa-circle-o" aria-hidden="true"></i>&nbsp;投诉信息</span></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="layui-body">
        ...
        <div style="padding: 0px;">
            <div class="page-top">
                <span style="color: #777777;font-size: 18px;font-family: 华文新魏;margin: 0 auto;"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;首页&nbsp;&gt;投诉信息</span>
            </div>
            <div class="big"  >
                ...
                <table class="layui-table" lay-data="{width: 1056, height:800, page:true}">
                    ...
                    <tr>
                        ...
                        <th lay-data="{field:'title', width:160, sort: true}">投诉标题</th>
                        <th lay-data="{field:'detail', width:260}">投诉详情</th>
                        <th lay-data="{field:'username', width:150, sort: true}">投诉修人</th>
                        ...
                        <c:forEach items="${list}" var="complain">
                            <tr>
                                ...
                                <td><a href="/upCompain.do?id=${complain.id}">确认</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                </table>
