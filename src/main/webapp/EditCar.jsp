    ...
    <div class="layui-body">
        ...
        <div style="padding: 0px;">
            ...
            <div class="big">
                <div class="action">
                    <center>
                        <form name="user" action="editCar.do" method="post" onsubmit=" return validate()">
                            <table width=70% border=1>
                                ...
                                <tr>
                                    <th>类型</th>
                                    <td>
                                        <input type="text" hidden value="${car.type}" id="type">
                                ...
                                <tr>
                                    <th>截止日期</th>
                                    <td> <input type="datetime-local" class="measureDate" name="outTime"></td>
                                </tr>
                                <tr>
...
<script>
    ...
    for(i=0;i<home.length;i++){
        if(home[i].value==name_card)
            home[i].selected = true;
    }
</script>
