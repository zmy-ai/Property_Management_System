    ...
    <div class="layui-body">
        ...
        <div style="padding: 0px;">
            ...
            <div class="big">
                <div class="action">
                    <center>
                        <form name="Floor" action="addFloor.do" method="get" onsubmit=" return validate()">
                            <table width=70% border=1>
                                ...
                                <tr>
                                    <th>楼栋编号</th>
                                    <td><input type="text" id="floor_name" name="floor_name"></td>
                                </tr>
                                <tr>
                                    <th>单元数量/栋</th>
                                ...
                                <tr>
                                    <th>房间数/单元</th>
                                    <td><input type="text" id="room_amount" name="room_amount" ></td>
                                </tr>
                                <tr>
